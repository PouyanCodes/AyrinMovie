...
namespace AyrinMovie.DataLayer.Migrations
{
    ...
    [Migration("20230205165431_AddLink&MovieLinkTables")]
    partial class AddLinkMovieLinkTables
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AyrinMovie.DataLayer.Entities.Movies.MovieLink", b =>
                {
                    b.Property<int>("MovieLink_Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("AyrinMovie.DataLayer.Entities.Movies.MovieLink", b =>
                {
                    b.HasOne("AyrinMovie.DataLayer.Entities.DownloadLinks.Link", "Link")
                        .WithMany("MovieLinks")
                        .HasForeignKey("LinkId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AyrinMovie.DataLayer.Entities.Movies.Movie", "Movie")
                        .WithMany("MovieLinks")
